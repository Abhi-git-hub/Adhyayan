...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaEdit, FaCheckCircle, FaExclamationCircle, FaGraduationCap, FaIdCard, FaCalendarAlt, FaBook, FaChalkboardTeacher } from 'react-icons/fa';
      ...
      <Container fluid>
        ...
        {profileData ? (
                ...
                <Card className="profile-card mb-4">
                  <Card.Body className="text-center">
                    ...
                    <div className="profile-badge">
                      ...
                      <span>{profileData.subject || 'Teacher'}</span>
                    </div>
                    
                    <div className="profile-info-item">
                      <FaIdCard className="info-icon" />
                      <span>ID: {profileData.teacherId || 'N/A'}</span>
                    </div>
                    ...
                    <div className="profile-info-item">
                      ...
                      <span>Subject: {profileData.subject || 'Not specified'}</span>
                    </div>
                  </Card.Body>
                </Card>
                ...
                <Card className="profile-card">
                  ...
                  <Card.Body>
                    <div className="status-item">
                      ...
                      <div className="status-value">Teacher</div>
                    </div>
                  ...
                  <Card.Body>
                    <Row>
                      <Col md={6}>
                        <div className="info-group">
                          <label>Subject</label>
                          <div className="info-value">{profileData.subject || 'Not assigned'}</div>
                        </div>
                      </Col>
                      ...
                      <Col md={6}>
                        <div className="info-group">
                          <label>Teacher ID</label>
                          <div className="info-value">{profileData.teacherId || 'Not assigned'}</div>
                        </div>
                      </Col>
                    </Row>
          ...
          <div className="profile-not-found">
            ...
            <p>
              We couldn't find your profile information. Please make sure you are logged in as a teacher.
            </p>
          </div>
        )}
      </Container>
